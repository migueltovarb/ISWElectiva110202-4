...
function Login() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            const response = await fetch(`${("TURBOPACK compile-time value", "http://localhost:8000")}/api/registro/login/`, {
                method: 'POST',
                headers: {
...
_s(Login, "M0xFpnUoLG6V4sL7DnxIWThUgfY=", false, function() {
    return [
...
//# sourceMappingURL=app_login_page_jsx_6000ecd6._.js.map